...
heroText: cuicuiFun's Word
tagline: 技术与生活，一份耕耘，一份收获。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 前端必备
    details: CSS、JavaScript、TypeScript、ES6、Vue、React框架等基本前端技术
    link: /web/ # 可选
    imgUrl: /img/web.png # 可选
  - title: 工程化
    details: Webpack、Babel、NodeJS等核心工程化技术
    link: /program/
    imgUrl: /img/ui.png
  - title: 设计
    details: Git、浏览器与网络、设计模式、架构设计等技能点
    link: /technology/
